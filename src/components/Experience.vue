<template>
  <div class="container py-16 md:py-20" id="work">
            ...
            <div class="relative mx-auto mt-12 flex w-full flex-col lg:w-2/3">
              <span
                class="absolute inset-y-0 left-2/5 ml-10 hidden w-0.5 bg-grey-40 md:block"
              ></span>
              ...
              >
                <div class="md:w-2/5">
                  <div class="flex justify-center md:justify-start">
                    <span class="shrink-0">
                      <img
                        src="src/assets/img/logo-spotify.svg"
                        class="h-auto w-32"
                        alt="company logo"
                      />
                    </span>
              ...
              >
                <div class="md:w-2/5">
                  <div class="flex justify-center md:justify-start">
                    <span class="shrink-0">
                      <img
                        src="src/assets/img/logo-microsoft.svg"
                        class="h-auto w-32"
                        alt="company logo"
                      />
                    </span>
              ...
              >
                <div class="md:w-2/5">
                  <div class="flex justify-center md:justify-start">
                    <span class="shrink-0">
                      <img
                        src="src/assets/img/logo-fedex.svg"
                        class="h-auto w-32"
                        alt="company logo"
                      />
                    </span>
