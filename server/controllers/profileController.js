...
var getProfile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, profile, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, Profile_1.profileModel.findById({ _id: id })];
            case 1:
                profile = _a.sent();
                if (profile) {
...
var createProfile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var createdProfile, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Profile_1.profileModel.create(req.body)];
            case 1:
                createdProfile = _a.sent();
...
var updateProfile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Profile_1.profileModel.findByIdAndUpdate({ _id: id }, {
...
var deleteProfile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Profile_1.profileModel.findByIdAndDelete({ _id: id })];
            case 2:
            ...
            case 3:
                err_4 = _a.sent();
                res.status(404).json({ error: err_4.message } || 'An error occurred');
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
